...
export function PortfolioCategoryCard({ category }: PortfolioCategoryCardProps) {
    return (
        <Card className="relative overflow-hidden hover:shadow-md transition-all group p-0 m-0">
            ...
            <div className="aspect-video bg-muted relative overflow-hidden">
                {category.image ? (
                    ...
                    <div className="absolute inset-0 flex items-center justify-center text-muted-foreground bg-gradient-to-br from-primary/5 to-muted/50">
